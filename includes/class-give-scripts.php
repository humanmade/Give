	...
	public function global_admin_head() {
		...
		<style type="text/css" media="screen">
			@font-face {
				...
				src: url('<?php echo esc_url( GIVE_PLUGIN_URL . 'assets/dist/fonts/icomoon.eot?ngjl88' ); ?>');
				src: url('<?php echo esc_url( GIVE_PLUGIN_URL . 'assets/dist/fonts/icomoon.eot?#iefixngjl88' ) ?>') format('embedded-opentype'),
				url('<?php echo esc_url( GIVE_PLUGIN_URL . 'assets/dist/fonts/icomoon.woff?ngjl88' ); ?>') format('woff'),
				url('<?php echo esc_url( GIVE_PLUGIN_URL . 'assets/dist/fonts/icomoon.svg?ngjl88#icomoon' ); ?>') format('svg');
				font-weight: normal;
				font-style: normal;
			}
