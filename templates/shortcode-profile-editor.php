...
if ( is_user_logged_in() ) :
	...
	<form id="give_profile_editor_form" class="give-form" action="<?php echo esc_url( give_get_current_page_url() ); ?>" method="post">
		...
		<fieldset>
			...
			<h3 id="give_profile_password_label" class="give-section-break"><?php esc_html_e( 'Change your Password', 'give' ); ?></h3>
			...
			<p id="give_profile_submit_wrap">
				...
				<input name="give_profile_editor_submit" id="give_profile_editor_submit" type="submit"
				       class="give_submit" value="<?php esc_html_e( 'Save Changes', 'give' ); ?>"/>
			</p>
		...
		if ( isset( $_GET['update_code'] ) ) {
			switch ( $_GET['update_code'] ) {
				case '2':
					...
					esc_html_e( 'Login with your new credentials.', 'give' );
					echo give_login_form(); // WPCS: XSS ok.
					break;
